...
<body>
    <section id="container">
        ...
        <header class="header fixed-top clearfix">
            <!--logo start-->
            <div class="brand">
                <a href="/MomAndBaby/staff" class="logo">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li onclick="return confirm('Are you sure to logout?')">
                                <a href="/MomAndBaby/staff/logout">
            ...
            <div id="sidebar" class="nav-collapse" style="background-color: rgb(148 111 111 / 78%)">
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li>
                            <a href="/MomAndBaby/staff/blog">
                                <span>Blog</span>
                            </a>
                        </li>
                        <li>
                            <a href="/MomAndBaby/staff/preorder">
                                <span>Pre order</span>
                            </a>
                        </li>
                        <li>
                            <a href="/MomAndBaby/staff/send-mail">
                                <span>Mail</span>
                            </a>
                        </li>
                        <li>
