<%-- 
    Document   : header
    Created on : May 23, 2024, 11:41:40 PM
    Author     : HP
--%>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a href="/MomAndBaby" class="nav-link">Home</a></li>
                        <li class="nav-item"><a href="/MomAndBaby/blog" class="nav-link">Blog</a></li>
                    </ul>
                </div>
            </div>
        </nav>