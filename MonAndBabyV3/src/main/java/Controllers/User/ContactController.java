...
public class ContactController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if(btn != null) {
            ...
            String emailAdmin = "letankim2003@gmail.com";
            ...
            if(isSend)  {
                response.sendRedirect("/MomAndBaby/contact?act=send-contact&status=1");
            } else {
                response.sendRedirect("/MomAndBaby/contact?act=send-contact&status=0");
            }
        } else {
