 ...
 * @author HP
 */
public class ForgetPasswordStaffController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ForgetPasswordStaffController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ForgetPasswordStaffController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
         request.getRequestDispatcher("/staff/view/auth/forget.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        if (request.getParameter("reset-password") != null) {
            ...
            if (a == null || !a.getEmail().equals(email)) {
                ...
                return;
            } else if(a != null && !a.getRoleName().toLowerCase().equals("staff")) {
