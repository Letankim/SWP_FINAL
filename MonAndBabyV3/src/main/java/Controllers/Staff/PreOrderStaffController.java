...
public class PreOrderStaffController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (path.endsWith("/MomAndBaby/staff/preorder")) {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (allItemChecked == null) {
                response.sendRedirect("/MomAndBaby/staff/preorder?act=action-preorder&status=2");
                return;
            }
            int status = 0;
            ...
            String url = "/MomAndBaby/staff/preorder?act=action-preorder&status=" + status;
