<%-- 
    Document   : opt
    Created on : May 24, 2024, 4:26:35 PM
    Author     : HP
--%>
            ...
            <div class="col-md-6" style="padding: 100px; margin-top: 70px">
                ...
                <form action="/MomAndBaby/register" method="post">
                    <div style="width: 400px; margin-bottom: 20px; margin-top: 20px">
                        ...
                        <input type="hidden" id="countdownValue" name="countdownValue" value="${timemount == null ? 60 : timemount}">
                ...
                <form method="post" action="/MomAndBaby/register">
