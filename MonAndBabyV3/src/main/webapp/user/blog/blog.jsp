<%-- 
    Document   : blog
    Created on : May 23, 2024, 11:15:46 PM
    Author     : HP
--%>
        ...
        <div class="row">
                    ...
                    <c:forEach items="${blogs}" var="blog">
                        <div class="col-md-12 d-flex ftco-animate">
                            <div class="blog-entry align-self-stretch d-md-flex">
                                <a href="/MomAndBaby/blog/view/${blog.ID}" class="block-20" style="background-image: url('${blog.image}');">
                                </a>
                                <div class="text d-block pl-md-4">
                                    ...
                                    <p>${blog.shortDesc}</p>
                                    <p><a href="/MomAndBaby/blog/view/${blog.ID}" class="btn btn-primary py-2 px-3">Read more</a></p>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
            ...
            <div class="col-lg-4 sidebar ftco-animate">
                <div class="sidebar-box">
                    <form action="/MomAndBaby/blog" method="post" class="search-form">
                    ...
                    <ul class="categories">
                        <c:forEach items="${categories}" var="cat">
                            ...
                            <c:if test="${numberOfPost > 0}">
                                <li><a href="/MomAndBaby/blog/category/${cat.ID}">${cat.name} <span>(${numberOfPost})</span></a></li>
                                </c:if>
                            </c:forEach>
                    </ul>
                </div>
