<%-- 
    Document   : view
    Created on : May 23, 2024, 11:40:40 PM
    Author     : HP
--%>
                ...
                <div class="sidebar-box ftco-animate">
                    ...
                    <c:forEach items="${productHelp}" var="product">
                        <div class="block-21 mb-4 d-flex" style="padding:10px;border: 1px solid #fc8383">
                            ...
                            <div class="text">
                                <h3 class="heading-1"><a href="/MomAndBaby/product/detail/${product.ID}">${product.name}</a></h3>
                                <div class="meta">
                                    <div>
                                        <a href="/MomAndBaby/product/detail/${product.ID}">
