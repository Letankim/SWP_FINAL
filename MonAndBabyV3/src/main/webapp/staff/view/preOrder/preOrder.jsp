<%-- 
    Document   : blog
    Created on : May 23, 2024, 8:51:18 AM
    Author     : HP
--%>
            ...
            <div class="table-agile-info">
                <div class="panel panel-default">
                    ...
                    <div class="table-responsive" style="padding: 5px;">
                        ...
                        <form method="post" action="/MomAndBaby/staff/preorder">
                            ...
                            <table id="product" class="table table-striped b-t b-light">
                                ...
                                <c:forEach items="${preOrders}" var="preorder">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="/MomAndBaby/staff/account/update/${accountPreOrder.ID}">${accountPreOrder.username}</a></td>
                                        <td><span class="text-ellipsis">${accountPreOrder.email}</span></td>
                                        <td>
                                            <a href="/MomAndBaby/staff/product/view/${productPreOrder.ID}">${productPreOrder.name}</a>
                                        </td>
                                        <td>
