                ...
                <section class="panel">
                    ...
                    <c:set var="category" value="${currentCategory}"></c:set>
                        <div class="panel-body">
                            <div class=" form">
                                <form class="cmxform form-horizontal" method="post" action="/MomAndBaby/admin/category">
                                ...
                                <a class="btn btn-info btn-back-to-page" href="/MomAndBaby/admin/category"><< Back to category</a>
                            </div>
                        </div>
                    </section>
                </div>
