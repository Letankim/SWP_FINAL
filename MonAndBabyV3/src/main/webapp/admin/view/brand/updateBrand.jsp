<%-- 
    ...
    Created on : May 17, 2024, 5:59:40 PM
    Author     : HP
--%>
                ...
                <section class="panel">
                    ...
                    <c:set var="brand" value="${currentBrand}"></c:set>
                        <div class="panel-body">
                            <div class=" form">
                                <form class="cmxform form-horizontal" method="post" action="/MomAndBaby/admin/brand" enctype="multipart/form-data">
                                ...
                                <a class="btn btn-info btn-back-to-page" href="/MomAndBaby/admin/brand"><< Back to brand</a>
                            </div>
                        </div>
                    </section>
                </div>
